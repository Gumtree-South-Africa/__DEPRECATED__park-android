...
public class GroupFollowersEditActivity extends BaseSessionActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			ScreenManager.showGroupFollowersEditFragment(this, groupId);
		}
	}
	...
	public void onBackPressed() {
		GroupFollowersEditFragment fragment = (GroupFollowersEditFragment) getSupportFragmentManager()
