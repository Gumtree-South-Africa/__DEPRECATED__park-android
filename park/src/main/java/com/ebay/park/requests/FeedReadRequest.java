...
public class FeedReadRequest extends BaseParkSessionRequest<Boolean>  {

    private String mFeedId;

    public FeedReadRequest(String feedId) {
        super(Boolean.class);
        this.mFeedId = feedId;
    }
    ...
    protected String getUrlFormat() {
        return String.format(ParkUrls.ACTIVITY_FEED_MARK_READ, getApiUri(), mFeedId);
    }
