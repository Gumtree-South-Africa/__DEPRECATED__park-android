...
public class FollowedRequest extends BaseParkSessionRequest<UserListResponse> {

	private String mUsername;

	public FollowedRequest(String username) {
	...
	protected String getUrlFormat() {
		...
		if (ParkApplication.getInstance().getSessionToken() != null) {
			return String.format(ParkUrls.FOLLOWED, getApiUri(), mUsername);
		} else {
			return String.format(ParkUrls.PUBLIC_FOLLOWED, getApiUri(), mUsername);
		}
	}
