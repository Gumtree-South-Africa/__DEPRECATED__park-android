 ...
 * 
 */
public class GroupUnsubscribeRequest extends BaseParkSessionRequest<Boolean> {

	private long mIdGroup;

	public GroupUnsubscribeRequest(long idGroup) {
		super(Boolean.class);
	...
	protected String getUrlFormat() {
		return String.format(ParkUrls.UNSUBSCRIBE_GROUP, getApiUri(), mIdGroup);
	}
