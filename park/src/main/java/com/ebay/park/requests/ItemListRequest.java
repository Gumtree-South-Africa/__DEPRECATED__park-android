 ...
 * 
 */
public class ItemListRequest extends BaseParkSessionRequest<ItemListResponse> {

	private Map<String, String> mFilters;

	private ItemListRequest(Builder builder) {
	...
	protected ItemListResponse getRequestModel(BaseParkResponse response) {
		...
		return getGson().fromJson(json, ItemListResponse.class);
	}
	...
	public static class Builder {
		...
		public ItemListRequest build() {
			return new ItemListRequest(this);
		}
