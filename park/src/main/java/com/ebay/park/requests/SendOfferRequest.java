 ...
 *
 */
public class SendOfferRequest extends BaseParkSessionRequest<Long> {

	private static final String ITEM_ID_KEY = "itemId";
	private static final String OFFERED_PRICE_KEY = "offeredPrice";
	 ...
	 *            The offered price.
	 */
	public SendOfferRequest(long itemId, long conversationId, double offeredPrice) {
		super(Long.class);
		mParams = new HashMap<String, Object>();
		mParams.put(ITEM_ID_KEY, itemId);
        mParams.put(OFFERED_PRICE_KEY, offeredPrice);
		if (conversationId > 0) {
	...
	protected String getUrlFormat() {
		return String.format(ParkUrls.SEND_OFFER, getApiUri());
	}
